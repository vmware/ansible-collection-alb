...
def main():
    argument_specs = dict(
        ...
        common_criteria_mode=dict(
            type="bool",
        ),
        configpb_attributes=dict(
            type="dict",
        ),
        controller_analytics_policy=dict(
            type="dict",
        ),
        default_license_tier=dict(
            type="str",
        ),
        ...
        host_key_algorithm_exclude=dict(
            type="str",
        ),
        kex_algorithm_exclude=dict(
            type="str",
        ),
        ...
        rekey_time_limit=dict(
            type="str",
        ),
        rekey_volume_limit=dict(
            type="str",
        ),
        secure_channel_configuration=dict(
            type="dict",
        ),
        ...
        welcome_workflow_complete=dict(
            type="bool",
        ),
    )
