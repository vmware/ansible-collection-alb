...
def main():
    argument_specs = dict(
        ...
        after_reboot_rollback_fnc=dict(
            type="str",
        ),
        after_reboot_task_name=dict(
            type="str",
        ),
        clean=dict(
            type="bool",
        ...
        enable_patch_rollback=dict(
            type="bool",
        ),
        enable_rollback=dict(
            type="bool",
        ),
        end_time=dict(
            type="str",
        ...
        patch_image_path=dict(
            type="str",
        ),
        patch_image_ref=dict(
            type="str",
        ),
        patch_list=dict(
            type="list",
        ...
        prev_image_path=dict(
            type="str",
        ),
        prev_patch_image_path=dict(
            type="str",
        ),
        prev_remote_image_ref=dict(
            type="str",
        ),
        previous_image_ref=dict(
            type="str",
        ),
        previous_patch_image_ref=dict(
            type="str",
        ),
        previous_patch_list=dict(
            type="list",
            elements="dict",
        ),
        previous_patch_version=dict(
            type="str",
        ),
        ...
        remote_image_ref=dict(
            type="str",
        ),
        se_patch_image_path=dict(
            type="str",
        ),
        se_patch_image_ref=dict(
            type="str",
        ),
        se_upgrade_events=dict(
            type="list",
            elements="dict",
        ),
        seg_params=dict(
