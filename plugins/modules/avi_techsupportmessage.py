...
DOCUMENTATION = '''
---
module: avi_techsupportmessage
author: Parikshit Manur (@pm020058) <parikshit.manur@broadcom.com>
short_description: Module for setup of TechSupportMessage Avi RESTful Object
description:
    - This module is used to configure TechSupportMessage object.
...
- name: Deploy Avi Controller
  ...
  vars:
    avi_credentials:
      ...
      api_version: "21.1.1"
  tasks:
    - name: Example to create TechSupportMessage object
      vmware.alb.avi_techsupportmessage:
        avi_credentials: "{{ avi_credentials }}"
        state: present
        name: sample_techsupportmessage
"""

RETURN = '''
obj:
    description: TechSupportMessage (api/techsupportmessage) object
