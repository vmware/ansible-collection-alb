...
DOCUMENTATION = '''
---
module: avi_akoamkocluster
author: Parikshit Manur (@pm020058) <parikshit.manur@broadcom.com>
short_description: Module for setup of AkoAmkoCluster Avi RESTful Object
description:
    - This module is used to configure AkoAmkoCluster object.
...
- name: Deploy Avi Controller
  ...
  vars:
    avi_credentials:
      ...
      api_version: "21.1.1"
  tasks:
    - name: Example to create AkoAmkoCluster object
      vmware.alb.avi_akoamkocluster:
        avi_credentials: "{{ avi_credentials }}"
        state: present
        name: sample_akoamkocluster
"""

RETURN = '''
obj:
    description: AkoAmkoCluster (api/akoamkocluster) object
...
def main():
    ...
    return avi_ansible_api(module, 'akoamkocluster',
                           set())
