...
def main():
    argument_specs = dict(
        ...
        ocsp_error_status=dict(
            type="str",
        ),
        ocsp_responder_url_list_from_certs=dict(
            type="list",
            elements="str",
        ),
        ocsp_response_info=dict(
            type="dict",
        ),
        status=dict(
            type="str",
