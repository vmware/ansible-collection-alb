...
DOCUMENTATION = '''
---
module: avi_localworkerfdsversion
author: Gaurav Rastogi (@grastogi23) <grastogi@avinetworks.com>
short_description: Module for setup of LocalWorkerFdsVersion Avi RESTful Object
description:
...
RETURN = '''
obj:
    description: LocalWorkerFdsVersion (api/localworkerfdsversion) object
...
def main():
    ...
    return avi_ansible_api(module, 'localworkerfdsversion',
                           set())
