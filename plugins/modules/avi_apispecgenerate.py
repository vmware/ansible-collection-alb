...
DOCUMENTATION = '''
---
module: avi_apispecgenerate
author: Parikshit Manur (@pm020058) <parikshit.manur@broadcom.com>
short_description: Module for setup of ApiSpecGenerate Avi RESTful Object
description:
...
RETURN = '''
obj:
    description: ApiSpecGenerate (api/apispecgenerate) object
...
def main():
    ...
    return avi_ansible_api(module, 'apispecgenerate',
                           set())
