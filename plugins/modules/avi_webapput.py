...
def main():
    argument_specs = dict(
        ...
        default_first_int=dict(
            type="int",
        ),
        default_second_int=dict(
            type="int",
        ),
        default_string=dict(
            type="str",
        ),
        default_third_int=dict(
            type="int",
        ),
        mandatory_test=dict(
            type="dict",
        ...
        sensitive_tests=dict(
            type="list",
            elements="dict",
        ),
        skip_optional_check_tests=dict(
            type="bool",
        ),
        string_length_test=dict(
            type="dict",
        ),
        string_length_tests=dict(
            type="list",
            elements="dict",
        ),
        tenant_ref=dict(
    ...
    return avi_ansible_api(module, "webapput", ["test_sensitive_string"])
