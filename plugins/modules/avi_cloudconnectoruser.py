...
def main():
    argument_specs = dict(
        ...
        nsxt_credentials=dict(
            type="dict",
        ),
        obj_password=dict(
            type="str",
        ),
        oci_credentials=dict(
            type="dict",
        ),
        private_key=dict(
            type="str",
    ...
    return avi_ansible_api(module, "cloudconnectoruser", ["password", "private_key"])
