...
.. raw:: html
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        ...
        <tr>
            ...
            <td>
                                                <div style="font-size: small">
                  - A resolved version of the active application specific rules together with the overrides.
                </div>
                                <div style="font-size: small">
