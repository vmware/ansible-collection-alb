        ...
        <tr>
            ...
            <td>
                  ...
                  - SYSERR_CHECK_LICENSE_CONSUMPTION, SYSERR_CHECK_LINUX_INFRA_HEALTH, SYSERR_CHECK_GSLBSERVICE_DISRUPTION, SYSERR_CHECK_MAX_DISK_SIZE_PERCENT_TS,
                                ...
                                <div style="font-size: small">
                  - SYSERR_CHECK_MIN_FREE_DISK_REQUIRED_TS, SYSERR_CHECK_SE_REACHABILITY_TS, SYSERR_CHECK_CLOUD_STATE, SYSERR_MC_UPGRADE_LICENSE_ERR,
                </div>
                                <div style="font-size: small">
                  ...
                  - SYSERR_GSLBSERVICE_DISRUPTED_ERR, SYSERR_CHECK_MAX_DISK_SIZE_PERCENT_TS_ERR, SYSERR_CHECK_MIN_FREE_DISK_REQUIRED_TS_ERR,
                                ...
                                <div style="font-size: small">
                  - SYSERR_CHECK_SE_REACHABILITY_TS_ERR, SYSERR_MC_CHECK_CLOUD_STATE_ERR, SYSERR_VS_NOT_FOUND, SYSERR_DEFAULT_POOL_NOT_FOUND,
                </div>
                                <div style="font-size: small">
                  - SYSERR_PROXY_POOL_NOT_FOUND, SYSERR_MISSING_APPLICATION_PROFILE, SYSERR_APP_PROFILE_NOT_FOUND, SYSERR_WAF_POLICY_NOT_FOUND, SYSERR_DUPLICATE_VS,
                </div>
                                <div style="font-size: small">
                  - SYSERR_WRONG_VS_TYPE, SYSERR_POOL_IN_PG_NOT_FOUND, SYSERR_PG_IN_PG, SYSERR_LB_MODULE_INIT_FAILED, SYSERR_CONNPOOL_MODULE_INIT_FAILED,
                </div>
                                <div style="font-size: small">
