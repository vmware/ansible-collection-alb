...
.. raw:: html
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        ...
        <tr>
            ...
            <td>
                                                <div style="font-size: small">
                  - Field deprecated in 31.2.3, 32.1.2.
                </div>
                                <div style="font-size: small">
                  - Allowed with any value in enterprise, essentials, basic, enterprise with cloud services edition.
                </div>
            ...
            <td>
                  ...
                  - GSLBSSLKEYANDCERTIFICATERUNTIME, GSLBGEOFILE, GSLBGEOFILERUNTIME, EVENTINFO, GSLBSITEHTTPTABLE, LOCALWORKERFDSVERSION, GSLBSERVICEHEALTHSTATUS,
                                ...
                                <div style="font-size: small">
                  - GSLBFILEOBJECTRUNTIME, GSLBRUNTIMESUMMARY, GSLBRUNTIMEDETAIL, GSLBRUNTIMEINTERNAL, GSLBLEADERCHANGERUNTIME, MSGLBTRANSACTIONRUNTIME,
                </div>
                                <div style="font-size: small">
                  - MSGLBCONNECTIONRUNTIME, MSGLBCONNPOOLRUNTIME, MSGLBCONTEXTRUNTIME, LABELPROFILE, APIPATH, APISCHEMA, APIPOLICY, WAAPSTATS, APIPATHSTATS,
                </div>
                                <div style="font-size: small">
                  - APISPECGENERATE, VIRTUALSERVICELEARNINGSTATS, WAAPPATHTREENODE.
                </div>
                                <div style="font-size: small">
                  - Field introduced in 31.1.1.
                </div>
