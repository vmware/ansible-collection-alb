...
**Module for setup of ApiSession Avi RESTful Object**
...
Synopsis
--------
- This module is used to configure ApiSession object.
    ...
    - hosts: localhost
      ...
      vars:
        avi_credentials:
          ...
          api_version: "21.1.1"
      tasks:
        - name: Example to create ApiSession object
          avi_api_session:
            avi_credentials: "{{ avi_credentials }}"
            state: present
            name: sample_api_session
