...
**Module for setup of ApiPath Avi RESTful Object**
        ...
        <tr>
            ...
            <td>
                  ...
                  - Default value when not specified in API or module is interpreted by Avi Controller as API_ACTION_INHERIT_FROM_API_POLICY.
                                    ...
                                    <td colspan="6">
                <div class="ansibleOptionAnchor" id="parameter-"></div>
                <b>failed_validation_query_parameter_action</b>
                <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                <div style="font-size: small">
                                                                        <span style="color: purple">str</span>
                                                            </div>
            ...
            <td>
                                                <div style="font-size: small">
                  - Unique identifier for this operation from the openapi specification.
                </div>
                                <div style="font-size: small">
                  - Field introduced in 32.2.1.
                </div>
                  ...
                  - Allowed with any value in enterprise, essentials, basic, enterprise with cloud services edition.
                                    ...
                                    <td colspan="6">
                <div class="ansibleOptionAnchor" id="parameter-"></div>
                <b>override_global_active_api_labels</b>
                <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                <div style="font-size: small">
                                                                        <span style="color: purple">bool</span>
                                                            </div>
            ...
            <td>
                  ...
                  - Allowed with any value in enterprise, essentials, basic, enterprise with cloud services edition.
                            ...
                            <td class="elbow-placeholder"></td>
                                    <td colspan="5">
                <div class="ansibleOptionAnchor" id="parameter-"></div>
                <b>failed_validation_request_body_action</b>
                <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                <div style="font-size: small">
                                                                        <span style="color: purple">str</span>
                                                            </div>
            ...
            <td>
                  ...
                  - Allowed with any value in enterprise, essentials, basic, enterprise with cloud services edition.
                            ...
                            <td class="elbow-placeholder"></td>
                                    <td colspan="5">
                <div class="ansibleOptionAnchor" id="parameter-"></div>
                <b>response_header_parameters</b>
                <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                <div style="font-size: small">
                                                                        <span style="color: purple">list / elements=dictionary </span>
                                                            </div>
            ...
            <td>
                                                <div style="font-size: small">
                  - Source of this endpoint.
                </div>
                                <div style="font-size: small">
                  - Only set to source_user_defined when the endpoint is copied from a user-defined apipath during spec sync.
                </div>
                                <div style="font-size: small">
                  - Unset means the endpoint has the same source as the apipath it belongs to.
                </div>
                                <div style="font-size: small">
                  - May also be used in the discovered config flow to merge discovered endpoints with existing paths.
                </div>
                                <div style="font-size: small">
            ...
            <td>
                  ...
                  - Default value when not specified in API or module is interpreted by Avi Controller as API_TYPE_ACTIVE.
                                    ...
                                    <td colspan="6">
                <div class="ansibleOptionAnchor" id="parameter-"></div>
                <b>unknown_status_code_action</b>
                <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                <div style="font-size: small">
                                                                        <span style="color: purple">str</span>
                                                            </div>
