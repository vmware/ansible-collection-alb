        ...
        <tr>
            ...
            <td>
                  ...
                  - Allowed with any value in enterprise, enterprise with cloud services edition.
                                ...
                                <div style="font-size: small">
                  - Allowed in essentials (allowed values- never), basic (allowed values- never) edition.
                </div>
                                <div style="font-size: small">
                  - Special default for essentials edition is never, basic edition is never, enterprise edition is non_default_80_443.
                </div>
                                <div style="font-size: small">
            ...
            <td>
                  ...
                  - Allowed with any value in enterprise, essentials, enterprise with cloud services edition.
                                ...
                                <div style="font-size: small">
                  - Allowed in basic (allowed values- http) edition.
                </div>
                                <div style="font-size: small">
            ...
            <td>
                  ...
                  - Default value when not specified in API or module is interpreted by Avi Controller as 10.
                                            ...
                                            <td colspan="7">
                <div class="ansibleOptionAnchor" id="parameter-"></div>
                <b>graceful_disable_timeout_sec</b>
                <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                <div style="font-size: small">
                                                                        <span style="color: purple">int</span>
                                                            </div>
            ...
            <td>
                  ...
                  - Default value when not specified in API or module is interpreted by Avi Controller as 60.
                                            ...
                                            <td colspan="7">
                <div class="ansibleOptionAnchor" id="parameter-"></div>
                <b>graceful_hm_down_disable_timeout</b>
                <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                <div style="font-size: small">
                                                                        <span style="color: purple">int</span>
                                                            </div>
            ...
            <td>
                  ...
                  - Allowed with any value in enterprise, enterprise with cloud services edition.
                                ...
                                <div style="font-size: small">
                  - Allowed in essentials (allowed values- lb_algorithm_consistent_hash_source_ip_address), basic (allowed values-
                </div>
                                <div style="font-size: small">
            ...
            <td>
                  ...
                  - Allowed with any value in enterprise, enterprise with cloud services edition.
                                ...
                                <div style="font-size: small">
                  - Allowed in essentials (allowed values- 128), basic (allowed values- 128) edition.
                </div>
                                <div style="font-size: small">
            ...
            <td>
                  ...
                  - Second, the maximum idle time while receiving data - the timer resets each time data arrives, so the backend can take as long as needed to send
                                ...
                                <div style="font-size: small">
                  - the complete response as long as it doesnt stop sending data for longer than this timeout.
                </div>
                                <div style="font-size: small">
                  - Value of 0 (default) inherits from the service engine groups upstream_read_timeout and upstream_connect_timeout properties.
                </div>
                                <div style="font-size: small">
            ...
            <td>
                                                <div style="font-size: small">
                  - Srv record parameters for gslb service member.
                </div>
                                <div style="font-size: small">
                  - Field introduced in 31.1.1.
                </div>
