        ...
        <tr>
            ...
            <td>
                  ...
                  - NSXT_DFW_TAG_VM_SUCCESS, NSXT_DFW_TAG_VM_FAILED, NSXT_IP_GROUP_UPDATE_FAILED, NSXT_IP_GROUP_SYNC_NOT_SUPPORTED, NSXT_GROUP_FETCH_FAILED,
                                ...
                                <div style="font-size: small">
                  - NSXT_IP_GROUP_SYNC_MULTIPLE_NSX_URLS, UPGRADE_CONTROLLER_STARTED, UPGRADE_SE_GROUP_STARTED, RESUME_SE_GROUP_STARTED, PATCH_CONTROLLER_STARTED,
                </div>
                                <div style="font-size: small">
                  - PATCH_SE_GROUP_STARTED, ROLLBACK_CONTROLLER_STARTED, ROLLBACK_SE_GROUP_STARTED, ROLLBACKPATCH_CONTROLLER_STARTED, ROLLBACKPATCH_SE_GROUP_STARTED,
                </div>
                                <div style="font-size: small">
                  ...
                  - CENTRAL_LICENSE_SUBSCRIPTION, CENTRAL_LICENSE_UNSUBSCRIPTION, CENTRAL_LICENSE_REFRESH_SUCCESS, CENTRAL_LICENSE_REFRESH_FAILURE,
                                ...
                                <div style="font-size: small">
                  - ROLLBACK_CONTROLLER_ABORTED, ROLLBACKPATCH_CONTROLLER_ABORTED, UPGRADE_DRYRUN_STARTED, UPGRADE_DRYRUN_COMPLETED, UPGRADE_DRYRUN_ABORTED,
                </div>
                                <div style="font-size: small">
                  - AUDIT_COMPLIANCE_EVENT, LOGAGENT_STREAMING_CONN_EVENT, CONTROLLER_DB_ERROR, AVI_FALSE_POSITIVE_DETECTION, CONNECT_TO_METRICSMGR_ERROR,
                </div>
                                <div style="font-size: small">
                  - DNS_VS_STATUS, CONFIG_VERSION_ACK_STATUS, PRE_CHECK_STARTED, PRE_CHECK_COMPLETED, POSTGRES_REPLICATION_FAILED, SAML_METADATA_UPDATE_FAILED,
                </div>
                                <div style="font-size: small">
