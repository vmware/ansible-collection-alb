...
.. vmware.alb.avi_apispecgenerate:
...
**Module for setup of ApiSpecGenerate Avi RESTful Object**
...
Synopsis
--------
- This module is used to configure ApiSpecGenerate object.
    ...
    - name: Deploy Controller
      ...
      vars:
        avi_credentials:
          ...
          tenant: "admin"
      tasks:
        - name: Example to create ApiSpecGenerate object
          avi_apispecgenerate:
            avi_credentials: "{{ avi_credentials }}"
            state: present
            name: sample_apispecgenerate
